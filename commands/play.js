...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    if (serverQueue) {
      ...
      .setAuthor("Song has been added to queue", "https://media.giphy.com/media/dWOKEQ5ewh94RJLemj/giphy.gif")
    ...
    const play = async (song) => {
      ...
      let thing = new MessageEmbed()
      .setAuthor("Started Playing Music!", "https://media.giphy.com/media/tqfS3mgQU28ko/giphy.gif")
      .setThumbnail(song.img)
      .setColor("BLUE")
      .addField("Name", song.title, true)
      .addField("Duration", song.duration, true)
